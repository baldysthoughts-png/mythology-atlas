...
export const expandedContentSections: ContentSection[] = [
  ...
  cs('cs-divine-council-examples', 'topic-divine-council', 'Important Examples',
    "Atrahasis explicitly describes the divine assembly deliberating and consenting to the decision that culminates in the flood. Enūma eliš presents another major council scene: Marduk agrees to champion the gods only after demanding exalted authority, and the assembled gods later test his command, proclaim him king, and equip him for battle.",
    ['claim-enlil-assembly-deliberation', 'claim-enuma-elish-champion-kingship-condition', 'claim-enuma-elish-command-test']),
  cs('cs-divine-council-scholarly', 'topic-divine-council', 'Scholarly Interpretation',
    "The surviving narratives show that divine authority could be hierarchical without being simply absolute. Enlil may exercise great authority in Atrahasis, while other gods deliberate, consent, intervene, or work around decisions. Enūma eliš likewise presents Marduk's supreme kingship as something negotiated, tested, and formally granted by an assembly. Scholars therefore often treat the divine council as a model of collective governance structured by unequal rank.",
    ['claim-divine-council-collective-decision', 'claim-enlil-assembly-deliberation', 'claim-enuma-elish-champion-kingship-condition', 'claim-enuma-elish-command-test']),
  // ---------------- UNDERWORLD ----------------
  cs('cs-underworld-structure', 'topic-underworld', 'Structure',
    "The surviving texts do not preserve one universal gate system or single fixed political structure for the underworld. Inanna’s Descent uses seven gates, with Inanna surrendering regalia as she passes through them. The Death of Ur-Namma describes seven chief porters, underworld palaces, offerings to multiple powers, and a place for the dead king within the realm. In the Amarna recension of Nergal and Ereshkigal, Nergal’s forces are distributed across fourteen gates. These differences show that the architecture and hierarchy of the underworld vary by composition and recension.",
    ['claim-inanna-descent-seven-gates', 'claim-death-ur-namma-porters-banquet', 'claim-death-ur-namma-underworld-role', 'claim-ea357-fourteen-gates', 'claim-ea357-ending-marriage-kingship']),
  cs('cs-underworld-scholarly', 'topic-underworld', 'Scholarly Interpretation',
    "Mesopotamian underworld traditions share recurring features — divine rulers, restricted passage, institutions of judgment, and an irreversible separation from ordinary earthly life — but the surviving texts should not be flattened into a single standardized geography or hierarchy. The contrast between seven gates in Inanna’s Descent and fourteen in the Amarna Nergal and Ereshkigal recension is especially clear evidence of variation. Likewise, the generally bleak destiny of the dead should be distinguished from the specific honors, offices, or exceptional narrative roles granted to individual figures such as Ur-Namma or Nergal.",
    ['claim-underworld-no-moral-judgment', 'claim-inanna-descent-seven-gates', 'claim-death-ur-namma-underworld-role', 'claim-ea357-fourteen-gates', 'claim-ea357-ending-marriage-kingship']),
