...
export const expandedContentSections: ContentSection[] = [
  ...
  cs('cs-atrahasis-overview', 'text-atrahasis', 'What Is This Text?',
    "Atrahasis is an Akkadian composition recounting the creation of humanity to relieve the gods of labor, humanity's subsequent multiplication and noise crisis—often interpreted by scholars in terms of overpopulation—and the escalating divine responses that culminate in a great flood, survived by the text's namesake protagonist, Atrahasis, through Enki's intervention."),
  ...
  cs('cs-dumuzi-evidence-limits', 'deity-dumuzi', 'Evidence and Interpretation Limits',
    ...
    [
      'claim-dumuzi-c1-pastoral-gifts',
      'claim-dumuzi-inanna-marriage',
      'claim-dumuzi-descent-shepherd-seized',
      'claim-dumuzi-dream-direct',
      'claim-inanna-dumuzi-substitute',
      'claim-dumuzi-geshtinanna-direct',
      'claim-dumuzi-geshtinanna-sister',
      'claim-dumuzi-bilulu-badtibira-lament',
      'claim-dumuzi-tammuz-name',
    ]),
  ...
  cs('cs-atrahasis-structure', 'text-atrahasis', 'Structure',
    "The composition is generally organized across three tablets: the first covering the gods' labor dispute and the creation of humanity, the second covering human multiplication, the resulting noise crisis, and the escalating divine responses, and the third covering the flood itself and its aftermath."),
  cs('cs-atrahasis-what-it-says', 'text-atrahasis', 'What the Text Actually Says',
    "The surviving text explicitly describes humanity multiplying and the resulting noise disturbing Enlil's rest within the sequence leading to the flood, describes Enki's indirect warning to Atrahasis via a reed wall, and depicts a divine sacrifice and mixed reaction (grief and anger) from the gods following the flood. Interpreting the multiplication-and-noise sequence specifically as overpopulation is a scholarly reading rather than terminology stated by the ancient text itself.",
    ['claim-enlil-flood-instigator']),
